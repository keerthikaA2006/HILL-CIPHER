...
int main() {
  char msg[] = "KEERTHIKA", enc[100], dec[100];
  hill(msg, enc, 1); printf("Encrypted: %s\n", enc);
  hill(enc, dec, 0); printf("Decrypted: %s\n", dec);
}
```
## OUTPUT
<img width="1377" height="918" alt="Screenshot 2025-08-30 090545" src="https://github.com/user-attachments/assets/8e9759aa-b5aa-4a76-9172-11424126e7ec" />
